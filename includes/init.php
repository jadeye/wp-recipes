...
function recipe_init(){
	...
	$args = array(
		...
		'public'                => true, // read on front end
		'publicly_queryable'    => true, // in URL
		'show_ui'               => true,
		'show_in_menu'          => true,
		'query_var'             => true, // add the new post type to URL query vars
		'rewrite'               => array( 'slug' => 'recipe' ),
		'capability_type'       => 'post', // relative to user permissions
		'has_archive'           => true,
		'hierarchical'          => false, //child- parent relationship
		'menu_position'         => 20,
